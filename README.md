...
- **Built-in Testing** – Easily test agents and tools with pre-configured test utilities.  
- **Branching Workflow Ready** – Follow Git Flow: main → develop → feature branches.  
